...
WebUI.setText(findTestObject('Object Repository/Page_Register/input_land Islands_form-control btn-log bor_48151b'), '123124512412412')
...
WebUI.waitForElementVisible(findTestObject('Page_Register/div_Phone number is too long'), GlobalVariable.G_ShortTimeOut)
