...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Register/input_Login_password'), 'qeJ0sjJnwEs=')
...
WebUI.waitForElementVisible(findTestObject('Page_Register/p_The password field must be at least 8 characters in length'), 
