...
WebUI.setText(findTestObject('Object Repository/Page_Register/input_Login_email'), 'arfandiahmad7@test.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Register/input_Login_password'), 'SaLzXmhNQh84+cQgeOoy3g==')
...
WebUI.waitForElementVisible(findTestObject('Page_Register/p_The password field should have at least one lowercase letter, one uppercase letter, one digit, one special character, and is at least 8 characters long'), 
