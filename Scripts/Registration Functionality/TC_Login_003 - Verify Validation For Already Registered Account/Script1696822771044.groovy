...
WebUI.setText(findTestObject('Object Repository/Page_Register/input_Login_email'), 'arfandiahmad5@test.com')
...
WebUI.waitForElementVisible(findTestObject('Page_Register/div_Email already registered'), GlobalVariable.G_ShortTimeOut)
